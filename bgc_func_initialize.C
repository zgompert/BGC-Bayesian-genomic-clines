...
void initParams(paramcont * param, datacont * data, datadimcont * datadim,
  ...
  if(ngs == 1){
    initPcnt(data->p0cnt, data->glp0, datadim->nloci, datadim->nindP0);
    initPcnt(data->p1cnt, data->glp1, datadim->nloci, datadim->nindP1);
  }
...
void initParams2(paramcont * param, datacont * data, datadimcont * datadim,
  ...
  if (ngs == 1){
    initZngs(param,data,datadim,auxvar);
  }
  else {
