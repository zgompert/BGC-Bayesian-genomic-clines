...
void usage(char * name){
  ...
  fprintf(stderr, "-A     Infile with reference genetic data for parental population 0\n");
  fprintf(stderr, "-B     Infile with reference genetic data for parental population 1\n");
  fprintf(stderr, "-Z     Infile with reference genetic data for admixed population\n");
  ...
  fprintf(stderr, "-R     Boolean, use distinct reference set of loci for hybrid index [default = 0]\n");
